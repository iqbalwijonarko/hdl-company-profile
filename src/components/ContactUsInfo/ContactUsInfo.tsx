      ...
      <div className="contact-us-info">
        <div className="contact-us-info__wrapper">
          <div className="contact-us-info__left-content left-content">
            ...
            <div className="left-content__tagline">Start our journey, now, together.</div>
            <div className="left-content__message">Join the largest coal mining connections!</div>
